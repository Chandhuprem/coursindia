...
<div class="hero">
    <nav>
        ...
        <h5 style="font-size: 70px;">courseindia</h5>
			<ul>
...
$mypass1 = mysqli_real_escape_string($con,$_POST["user1"]);
      ...
      if($count == 1) {
        $ret=mysqli_query($con,"update adminpass set adminpass='$mypass1' where adminid='admin@1'");
        if($ret)
{
echo '<script>alert("New password added Successfully !!")</script>';
echo '<script>window.location.href=changepass.php</script>';
}else{
  echo '<script>alert("Error : New password not Updated!!")</script>';
echo '<script>window.location.href=changepass.php</script>';
}
      }else {
        ...
        <BR>
            ...
            <div style = "margin:30px">
               ...
               <form action = "" method = "POST">
                  ...
                  <label class="label" >New Password  :</label><input type = "password" name ="user1" class = "searchb" /><br/><br />
