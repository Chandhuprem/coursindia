...
<div class="label">
 ...
 <button type="submit" name="submit" class="btn btn-default">Submit</button>
        ...
        <?php
            ...
            $clink=$_POST['clink'];
            $ret=mysqli_query($con,"update courses set ctype='$coursename',cname='$courseunit',cpc='$seatlimit',clink='$clink' where  cno='$coursecode'");
if($ret)
{
echo '<script>alert("Course Updated Successfully !!")</script>';
echo '<script>window.location.href=submition.php</script>';
}else{
